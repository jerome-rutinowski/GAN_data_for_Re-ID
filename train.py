...
A_img_paths = py.glob(py.join(args.datasets_dir, args.dataset, 'trainC'), '*.jpeg')
B_img_paths = py.glob(py.join(args.datasets_dir, args.dataset, 'trainRL'), '*.jpeg')
...
A_img_paths_test = py.glob(py.join(args.datasets_dir, args.dataset, 'testC'), '*.jpeg')
B_img_paths_test = py.glob(py.join(args.datasets_dir, args.dataset, 'testRL'), '*.jpeg')
...
G_A2B = module.ResnetGenerator(input_shape=(args.crop_size//2, args.crop_size, 3))
G_B2A = module.ResnetGenerator(input_shape=(args.crop_size//2, args.crop_size, 3))

D_A = module.ConvDiscriminator(input_shape=(args.crop_size//2, args.crop_size, 3))
D_B = module.ConvDiscriminator(input_shape=(args.crop_size//2, args.crop_size, 3))
    ...
    for ep in tqdm.trange(args.epochs, desc='Epoch Loop'):
        ...
        for A, B in tqdm.tqdm(A_B_dataset, desc='Inner Epoch Loop', total=len_dataset):
            ...
            if ep%2==0:
                ...
                im.imwrite(img, py.join(sample_dir, 'iter-%09d.jpg' % ep))
